...
const Main = () => {
    const legendItems = [
        ...
        { title: 'DRAGONBALLde Akira Toriyama', description: 'Dragon Ball es una serie simple que destaca gracias a la espectacularidad de sus combates. Siendo parco en palabras, todo se reduce a villanos, entrenamientos y batallas. Esto no quiere decir que sea mala. Más bien todo lo contrario.' },
        ...
        <div className="main">
            ...
            <Carousel showThumbs={false}>
                {legendItems.map((item, index) => (
                    <div className="container-carrussel"key={index}>
                        <img src={eval(`carrusel${index + 1}`)} alt={`imagen${index + 1}`} />
                       <div> <p className="legend">{item.title}</p>
